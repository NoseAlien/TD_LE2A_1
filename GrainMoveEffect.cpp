...
GrainMoveEffect::GrainMoveEffect() :
	generateTimer(0), generateMaxTimer(5)
{
}
...
void GrainMoveEffect::Generate(const Vector3& pos, const float& radius)
{
	...
	if (generateTimer >= generateMaxTimer)
	{
		...
		float scale = Random::RangeF(0.2, 0.3);
